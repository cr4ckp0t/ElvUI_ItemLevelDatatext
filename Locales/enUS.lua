...
L["Alt + Click to Delete"] = true
L["Are you sure you want to delete %s?"] = true
L["Back"] = true
L["Change Equipment Set"] = true
L["Chest"] = true
L["Choose Equipment Set"] = true
L["Ctrl + Click to Save"] = true
L["Deleted equipment set |cff%s%s|r!"] = true
L["Equipment Set"] = true
L["Equipped"] = true
L["Feet"] = true
L["Hands"] = true
L["Head"] = true
L["Item Level Datatext"] = true
L["Item Level"] = true
L["Left Click"] = true
L["Legs"] = true
L["Main Hand"] = true
L["Neck"] = true
L["No Equipment Sets"] = true
L["None Equipped"] = true
L["Number of decimal places to round to for the average item level."] = true
L["Off Hand"] = true
L["Open Character Pane"] = true
L["Plugins by |cff0070deCrackpotx|r"] = true
L["Precision"] = true
L["Ranged"] = true
L["Rename %s to what?"] = true
L["Renamed |cff%s%s|r to |cff%s%s|r!"] = true
L["Right Click"] = true
L["Ring 1"] = true
L["Ring 2"] = true
L["Select which item level you want to display in the datatext, total or equipped."] = true
L["Shift + Click to Rename"] = true
L["Shoulders"] = true
